...
/*
  it("deposit should fail if maxSingleDepositValue exceeded", function() {
    ...
    var authorities = [accounts[0], accounts[1]];
    let userAccount = accounts[2];
    let maxSingleDepositValue = 100000000000000000;  // 1 ether
  ...
  it("deposit should fail if maxTotalMainContractBalance exceeded", function() {
    ...
    var authorities = [accounts[0], accounts[1]];
    let userAccount = accounts[2];
    let maxTotalMainContractBalance = 2000000000000000000;  // 1 ether
...
*/
  it("should allow correct withdraw without recipient paying for gas", function() {
    ...
    var value = web3.utils.toBN(1000000000000000000);
    ...
    return newMainBridge({
      ...
      return helpers.sign(accounts[0], message, {from: accounts[0]});
    }).then(function(result) {
      signature = result;
      ...
      //assert.equal(value, result.logs[0].args.value, "Event value should match value in message");
